...
import io.github.fishstiz.minecraftcursor.cursor.CursorProviderInternal;
...
public abstract class AbstractContainerScreenMixin implements CursorProviderInternal {
    @Shadow @Final protected AbstractContainerMenu menu;

    @Shadow @Nullable protected Slot hoveredSlot;

    @Override
    public CursorType minecraftcursor$getCursorType(double mouseX, double mouseY) {
