...
public abstract class CursorResourceListener {
    ...
    protected CursorResourceListener() {
    }
    ...
    private void loadCursorTexture(ResourceManager manager, CursorType cursorType, String basePath) {
        ...
        if (cursorResource == null) {
            MinecraftCursor.LOGGER.info("Cursor Type: '{}' not found", cursorType.getKey());
            return;
        }

        MinecraftCursor.LOGGER.info("Loading Cursor Type: '{}'", cursorType.getKey());
